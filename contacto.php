    ...
    <main class="container full-height my-4">
        <div class="row justify-content-between ">
            <div class="col-12 col-xl-8 mb-2 text-center">
                ...
                <div class="row py-3 my-3 text-dark">
            ...
            <div class="col-12 mt-2 col-xl-3 mt-3">
                <div class="row mt-2">
                    <div class="col-12 side-header">
                        <h5 class="text-left">¿En qué te podemos ayudar?</h5>
                    </div>
                </div>
                <form class="row mx-2 text-dark rounded mt-4">
                    <div class="col-12 col-md-6 col-xl-12">
                        <div class="form-row">
                            <label for="contacto_nombre" class="col-12 col-form-label">Nombre:</label>
                            <input type="text" class="col-12 form-control border-dark" id="contacto_nombre">
                        </div>
                        <div class="form-row">
                            <label for="contacto_nombre" class="col-12 col-form-label">Correo:</label>
                            <input type="email" class="col-12 form-control border-dark" id="contacto_nombre">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xl-12">
                        <div class="form-row">
                            <label for="contacto_nombre" class="col-12 col-form-label">Pregunta:</label>
                            <textarea class="form-control border-dark" id="" rows="5"></textarea>
                        </div>
                        <div class="form-row my-2 justify-content-end">
                            <button class="form-group btn btn-wow">Enviar</button>
                        </div>
                    </div>
                </form>
            </div>
